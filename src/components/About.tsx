...
const COURSEWORK: Course[] = [
  { name: "Aerodynamics", code: "MECH 6v95", description: "This course introduces students to methods used to calculate aerodynamic forces and moments present on surfaces exposed to high-speed external flows, principally with applications to flight vehicles. The course consists of three sections: a review of the governing equations of fluid mechanics and the basis for the inviscid-flow assumption, an introduction to inviscid, compressible (not low Mach number) flow, and an inviscid, incompressible (low Mach number) flow. By the end of the course, students will be able to compute the lift on two-dimensional thin airfoils at both low Mach numbers and in supersonic flow and explain the factors that produce drag on supersonic airfoils. MECH 6v95 students will complete a computational project related to supersonic lift and drag calculations for arbitrary airfoils shapes, supersonic wind tunnel design, or rocket nozzle design. Prerequisite: Consent of the instructor." },
  { name: "Sys Dynamics Mdlng & Analysis", code: "MECH 3340", description: "Dynamic analysis and simulation of common engineering systems with thermal, fluid, mechanical and electromechanical applications. Laplace transform techniques, time domain, and frequency response methods are used along with simulation techniques to analyze and predict system response to various input stimuli. Matlab and Simulink are used extensively throughout the course." },
  { name: "Heat Transfer", code: "MECH 3320", description: "This course focuses on steady state and time-dependent conduction in one- and two-dimensions; forced convection, internal and external flows; heat exchangers; introduction to radiation; elements of thermal system design." },
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between bg-white/[0.02] backdrop-blur-md px-6 py-4 border-b border-white/5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16">
            ...
            >
              ...
              <div className="relative w-full max-w-[280px]">
                ...
                <div className="flex items-center justify-between px-4 py-3 border border-white/10 border-b-0 rounded-t-lg bg-white/[0.02] backdrop-blur-md">
                  <TrafficLights />
